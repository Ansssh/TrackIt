    ...
    return (
        <div className='w-screen min-h-screen'>
            ...
            <main>
                ...
                <p className='text-4xl sm:text-5xl md:text-6xl text-center justify-between mt-6 font-extrabold px-8 sm:px-6 md:px-4'><span className='text-blue-700'>Track, Organize and Optimize</span> Your Job Search</p>
                ...
                <div>
                    ...
                    <div className='flex items-center justify-center gap-5 mt-4 mx-5'>
                        <IBM className={'h-10'}/>
                        <Google className={'h-10'}/>
                        <Rolex className={'h-10'}/>
                        <Goldman className={'h-10'}/>                    
                    </div>
                </div>
            </main>
            <footer className='w-screen flex justify-center absolute bottom-0 mb-2'>
